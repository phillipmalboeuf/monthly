...
class Core.Views.Survey extends Backbone.View
	...
	initialize: ->
		...
		@survey = new Core.Models.Survey({"_id": "56b60e72f5f9e96ffb235c64"})
		@survey.fetch()
	...
	submit_form: (e)->
		...
		@survey_answer = new Core.Models.SurveyAnswer()
		@survey_answer.local_storage = "survey_answer"
		@survey_answer.urlRoot = Core.settings.api + "surveys/" + @survey.id + "/answers"
		@survey_answer.save {
			answers: answers
		},
